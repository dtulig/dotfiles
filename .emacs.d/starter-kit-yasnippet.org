...
#+begin_src emacs-lisp
  (starter-kit-install-if-needed 'yasnippet 'yasnippet-snippets)
...
** Delete/disable selected snippets modes
These snippets cause more trouble than they are worth.
#+BEGIN_SRC emacs-lisp
  (let ((file (concat yasnippet-snippets-dir "/prog-mode" "/.yas-skip")))
