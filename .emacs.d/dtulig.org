...
#+BEGIN_SRC emacs-lisp
  ...
  (setq tide-format-options '(:indentSize 2 :convertTabsToSpaces t ))
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;       (lambda (argv)
  ;;         (let (root-dir (locate-dominating-file "default.nix"))
  ;;           (print root-dir)
  ;;          (append (list "nix-shell" "-I" "/home/dtulig/workspace/handmade-rs" "--command")
  ;;                              (list (mapconcat 'identity argv " "))) )
  ;;         ))
#+END_SRC
* General Defuns
