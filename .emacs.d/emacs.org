...
#+begin_src emacs-lisp
  (use-package nord-theme
    ...
    :config
    (load-theme 'nord t)
    (defun my/apply-nord-to-frame (frame)
      (with-selected-frame frame
        ...
        (when (display-graphic-p frame)
          ...
          (enable-theme 'nord)))
    (add-hook 'after-make-frame-functions #'my/apply-nord-to-frame))

  (custom-set-faces
   '(corfu-default ((t :background "#3b4252" :foreground "#d8dee9")))
   '(corfu-current ((t :background "#434c5e" :foreground "#eceff4"))))
...
#+begin_src emacs-lisp
  (use-package flyspell
    ...
    :custom-face
    (flyspell-incorrect ((t :underline (:style wave :color "#bf616a"))))
    (flyspell-duplicate ((t :underline (:style wave :color "#d08770")))))
