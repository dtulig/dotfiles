...
#+begin_src emacs-lisp
  (use-package gptel
    ...
    (setq
     ...
     gptel-model 'qwen35-27b
     gptel-backend (gptel-make-openai "llama-cpp"
                     :host dt/gptel-host
                     :stream t
                     :protocol "http"
                     :models '(gemma-27b gemma-31b qwen35-27b qwen35-35b-a3b qwen-coder-next qwen3-4b-instruct qwen3-4b-thinking glm45-air gpt-oss-120b gpt-oss-20b qwen35-122b-a10b))))
#+end_src
