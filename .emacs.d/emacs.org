...
#+begin_src emacs-lisp
  (use-package gptel
    ...
    (setq
     ...
     gptel-model 'qwen3-30b-instruct
     gptel-backend (gptel-make-openai "llama-cpp"
                     :host dt/gptel-host
                     :stream t
                     :protocol "http"
                     :models '(gemma-27b qwen3-30b-instruct qwen3-30b-thinking qwen3-30b-coder qwen3-4b-instruct qwen3-4b-thinking glm45-air gpt-oss-120b gpt-oss-20b))))
#+end_src
